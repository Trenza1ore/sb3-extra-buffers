...
from sb3_extra_buffers.gpu_buffers.compression_methods.compression_methods import rle_compress, rle_decompress
from sb3_extra_buffers.compressed.compression_methods.compression_methods import rle_numpy_decompress_old
...
def test_rle_compression_roundtrip(input_arr):
    ...
    th_decomp = rle_decompress(buffer, pos_runs, pos_elem, run_length, elem_type, runs_type,
